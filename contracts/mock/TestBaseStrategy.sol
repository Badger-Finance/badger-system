 ...
 */
abstract contract TestBaseStrategy {
    ...
    function migrate(address _newStrategy) external {
        ...
        require(TestBaseStrategy(_newStrategy).vault() == vault);
...
abstract contract BaseStrategyInitializable is TestBaseStrategy {
    event Cloned(address indexed clone);

    constructor(address _vault) public TestBaseStrategy(_vault) {}
