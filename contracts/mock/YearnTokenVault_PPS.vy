...
# Manually set PPS value for testing
pricePerShareVal: public(uint256)
...
def initialize(
    ...
    # Setting default PPS to 1
    self.pricePerShareVal = 10**DetailedERC20(token).decimals()
...
@external
def setPricePerShare(pps: uint256):
    self.pricePerShareVal = pps
...
def pricePerShare() -> uint256:
    ...
    """
    # Returns manually set PPS for testing
    return self.pricePerShareVal
