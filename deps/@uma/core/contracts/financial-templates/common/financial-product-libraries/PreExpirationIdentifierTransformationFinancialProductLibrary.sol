...
import "deps/deps/@openzeppelin/contracts/access/Ownable.sol";
...
contract PreExpirationIdentifierTransformationFinancialProductLibrary is FinancialProductLibrary, Ownable, Lockable {
     ...
     */
    function setFinancialProductTransformedIdentifier(address financialProduct, bytes32 transformedIdentifier) public onlyOwner nonReentrant() {
     ...
     */
    function getTransformedIdentifierForFinancialProduct(address financialProduct) public view nonReentrantView() returns (bytes32) {
     ...
     */
    function transformPriceIdentifier(bytes32 identifier, uint256 requestTime) public override view nonReentrantView() returns (bytes32) {
