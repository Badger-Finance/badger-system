...
abstract contract BaseRootTunnel is AccessControlMixin {
     ...
     */
    function setChildTunnel(address newChildTunnel) external only(DEFAULT_ADMIN_ROLE) {
    ...
    function _validateAndExtractMessage(bytes memory inputData) internal returns (bytes memory) {
        ...
        require(processedExits[exitHash] == false, "RootTunnel: EXIT_ALREADY_PROCESSED");
