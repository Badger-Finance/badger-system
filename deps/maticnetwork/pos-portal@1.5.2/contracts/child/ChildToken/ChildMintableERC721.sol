...
import {ERC721} from "deps/@openzeppelin/contracts/token/ERC721/ERC721.sol";
import {AccessControlMixin} from "../../common/AccessControlMixin.sol";
import {IChildToken} from "./IChildToken.sol";
import {NativeMetaTransaction} from "../../common/NativeMetaTransaction.sol";
import {ContextMixin} from "../../common/ContextMixin.sol";

contract ChildMintableERC721 is ERC721, IChildToken, AccessControlMixin, NativeMetaTransaction, ContextMixin {
     ...
     */
    function encodeTokenMetadata(uint256 tokenId) external virtual view returns (bytes memory) {
