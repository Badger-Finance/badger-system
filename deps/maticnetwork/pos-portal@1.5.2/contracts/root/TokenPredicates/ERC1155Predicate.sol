...
import {IERC1155} from "deps/@openzeppelin/contracts/token/ERC1155/IERC1155.sol";
...
contract ERC1155Predicate is ITokenPredicate, ERC1155Receiver, AccessControlMixin, Initializable {
    ...
    function lockTokens(
        ...
        emit LockedBatchERC1155(depositor, depositReceiver, rootToken, ids, amounts);
    ...
    function exitTokens(
        ...
        if (bytes32(logTopicRLPList[0].toUint()) == TRANSFER_SINGLE_EVENT_SIG) {
            ...
            IERC1155(rootToken).safeTransferFrom(address(this), withdrawer, id, amount, bytes(""));
