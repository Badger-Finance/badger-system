    ...
    ContextMixin
{
     ...
     */
    function registerPredicate(bytes32 tokenType, address predicateAddress) external override only(MAPPER_ROLE) {
    ...
    function mapToken(
        ...
        require(rootToChildToken[rootToken] == address(0) && childToRootToken[childToken] == address(0), "RootChainManager: ALREADY_MAPPED");
     ...
     */
    function cleanMapToken(address rootToken, address childToken) external override only(MAPPER_ROLE) {
    ...
    function _mapToken(
        ...
        require(typeToPredicate[tokenType] != address(0x0), "RootChainManager: TOKEN_TYPE_NOT_SUPPORTED");
        ...
        _stateSender.syncState(childChainManagerAddress, abi.encode(MAP_TOKEN, syncData));
    }
    ...
    function exit(bytes calldata inputData) external override {
        ...
        require(processedExits[exitHash] == false, "RootChainManager: EXIT_ALREADY_PROCESSED");
        ...
        ITokenPredicate(predicateAddress).exitTokens(_msgSender(), rootToken, logRLP.toRlpBytes());
    }
    ...
    function _checkBlockMembershipInCheckpoint(
        ...
        (bytes32 headerRoot, uint256 startBlock, , uint256 createdAt, ) = _checkpointManager.headerBlocks(headerNumber);
