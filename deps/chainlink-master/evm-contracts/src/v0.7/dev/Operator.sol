    ...
    WithdrawalInterface
{
    ...
    event AuthorizedSendersChanged(address[] senders);
    ...
    event ForwarderCreated(address indexed addr);
     ...
     * @return array of addresses
     */
    function getForwarders() external override view returns (address[] memory) {
    ...
    modifier onlyAuthorizedSender() {
        require(
            s_authorizedSenders[msg.sender],
