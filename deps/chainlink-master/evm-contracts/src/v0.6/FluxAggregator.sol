...
contract FluxAggregator is AggregatorV2V3Interface, Owned {
     ...
     */
    function latestAnswer() public virtual override view returns (int256) {
     ...
     * instead which includes better verification information.
     */
    function latestTimestamp() public virtual override view returns (uint256) {
     ...
     * instead which includes better verification information.
     */
    function latestRound() public virtual override view returns (uint256) {
