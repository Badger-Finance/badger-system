...
contract MaliciousMultiWordConsumer is ChainlinkClient {
    ...
    function stealEthCall(bytes32 _requestId, bytes memory)
        public
    ...
    function stealEthSend(bytes32 _requestId, bytes memory)
        public
        recordChainlinkFulfillment(_requestId)
    {
    ...
    function stealEthTransfer(bytes32 _requestId, bytes memory)
        public
        recordChainlinkFulfillment(_requestId)
    {
