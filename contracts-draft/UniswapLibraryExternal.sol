...
contract UniswapLibraryExternal {
    ...
    function swapExactETHForTokens(address router, uint256 balance, address[] memory path) public {
        require(badgerAccessControl.hasRole(UNI_V2_LIKE_ROUTER_ROLE, router), "Specified router not approved as UniV2 like router");
    ...
    function addMaxLiquidity(address router, address token0, address token1) public {
        require(badgerAccessControl.hasRole(UNI_V2_LIKE_ROUTER_ROLE, router), "Specified router not approved as UniV2 like router");
