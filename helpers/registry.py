...
token_registry = DotMap(
    ...
    ibbtc="0x61a18C93B957CaA1dc44710d62AE2A44930D242f",
)
...
defidollar_registry = DotMap(
    addresses=DotMap(
        badgerSettPeak="0x1a2a808478B3A4F889EC7Ea5c6E809B17C8Eb9Cf",
    ),
    pools=[
        DotMap(
            id=0,
...
class ContractRegistry:
    def __init__(self):
        ...
        self.defidollar = defidollar_registry
