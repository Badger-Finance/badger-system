...
def confirm_strategy_common_params(strategy, params):
    print(params.strategist, params.keeper)
    print(strategy.strategist(), strategy.keeper())
    ...
    # assert strategy.keeper() == params.strategist
    # assert strategy.guardian() == params.strategist
...
def confirm_badger_hunt_params(badgerHunt, params):
    print(params, badgerHunt.claimsStart())
...
def confirm_badger_tree_params(badger, tree, params):
    ...
    # print(ROOT_UPDATER_ROLE, GUARDIAN_ROLE)
...
# @pytest.mark.skip()
def confirm_setup_locking_infra(badger: BadgerSystem):
    # DAO Timelock
