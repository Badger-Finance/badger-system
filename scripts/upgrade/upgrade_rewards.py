...
VAULT_CONTROLLER = "https://etherscan.io/address/0x63cF44B2548e4493Fd099222A1eC79F3344D9682"
...
def test_update_rewards(
    ...
    console.print("[orange] Controller Rewards {} [/orange]".format(controller.rewards()))
    return result
...
def update_rewards(
    ...
    return badger.governance_queue_transaction(CONTROLLER_ADDRESS, FUNCTION_TO_CALL, data, eta)
