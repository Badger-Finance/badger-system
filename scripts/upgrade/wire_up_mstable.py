...
def main():
    ...
    controller = helper.contract_from_abi(badger.getController("experimental").address, "Controller", Controller.abi)

    asset = "0x17d8cbb6bce8cee970a4027d1198f6700a7a6c24"
    sett = helper.contract_from_abi(contracts["imBTC-vault"], "SettV3", SettV3.abi)
    strat = helper.contract_from_abi(contracts["imBTC-strategy"], "StrategyConvexStakingOptimizer", StrategyConvexStakingOptimizer.abi)
    ...
    strat = helper.contract_from_abi(contracts["fPmBtcHBtc-strategy"], "StrategyConvexStakingOptimizer", StrategyConvexStakingOptimizer.abi)
