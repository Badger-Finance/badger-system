...
from helpers.constants import DEFAULT_ADMIN_ROLE, PAUSER_ROLE, ROOT_PROPOSER_ROLE, ROOT_VALIDATOR_ROLE, UNPAUSER_ROLE
...
def main():
    ...
    multi.execute(
        ...
        ),
        {
            ...
            "data": badger.opsProxyAdmin.upgrade.encode_input(badger.badgerTree, newLogic),
        },
    )
