...
def assert_strategy_config_permissions(settConfig):
    # Setup
    badger = badger_single_sett(settConfig)
    state_setup(badger, settConfig)
...
def assert_strategy_pausing_permissions(settConfig):
    # Setup
    badger = badger_single_sett(settConfig)
    state_setup(badger, settConfig)
...
def assert_sett_pausing_permissions(settConfig):
    # Setup
    badger = badger_single_sett(settConfig)
    state_setup(badger, settConfig)
    settId = settConfig["id"]
...
def assert_sett_config_permissions(settConfig):
    # Setup
    badger = badger_single_sett(settConfig)
    state_setup(badger, settConfig)
    settId = settConfig["id"]
...
def assert_sett_earn_permissions(settConfig):
    # Setup
    badger = badger_single_sett(settConfig)
    state_setup(badger, settConfig)
    settId = settConfig["id"]
...
def assert_controller_permissions(settConfig):
    # ===== Controller =====
    # initialize - no-one
    # initialized = true
