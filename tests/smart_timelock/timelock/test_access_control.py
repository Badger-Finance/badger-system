...
#         setup.gToken.transfer(
#             setup.smartTimelock, setup.params.releaseAmount, {"from": setup.deployer}
#         )
...
#         tokenGifter,
#         0,
#         tokenGifter.requestTransfer.encode_input(gToken, params.tokenRequestAmount),
#     )
...
#         gToken,
#         0,
#         miscToken.approve.encode_input(stakingMock, MaxUint256),
#         {"from": team[0]},
#     )
