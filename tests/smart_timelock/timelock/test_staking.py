...
#     preBalances = get_token_balances(
#         [smartTimelock, stakingMock], [gToken, stakingMock]
#     )

#     smartTimelock.call(stakingMock, 0, stakingMock.stake.enocde_input(stakingAmount))

#     postBalances = get_token_balances(
#         [smartTimelock, stakingMock], [gToken, stakingMock]
#     )

#     assert (
#         postBalances.smartTimelock.gToken
#         == preBalances.smartTimelock.gToken - stakingAmount
#     )
#     assert (
#         postBalances.stakingMock.gToken
#         == preBalances.stakingMock.gToken + stakingAmount
#     )
